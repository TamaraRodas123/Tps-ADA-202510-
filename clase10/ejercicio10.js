...
let precioOriginal=parseFloat(prompt("Ingrese el precio en pesos: "));
let porcentajeDescuento= parseFloat(prompt("Ingrese el porcentahe de descuento: "));

let montoDescuento = precioOriginal * (porcentajeDescuento / 100);

let precioFinal= precioOriginal-montoDescuento;

console.log(`Su precio final con descuento aplicado es de: $ ${precioFinal}`);