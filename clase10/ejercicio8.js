...
/*En JavaScript, el método . parseFloat() analiza una cadena dada y devuelve el primer número de punto flotante que se encuentra en ella */
let celsius= parseFloat(prompt("Ingrese su temperatura en grados celcius: "));
let fahrenheit = celsius * 9 / 5 + 32;
console.log(`Su temperatura en farenheit es de: ${fahrenheit}`);