...
let modelosAutos=["ford","fiat","audi","ford","reanault","audi"];
let modelo=prompt("Ingrese el modelo de auto del que desea saber la ultima ubicación en la lista: ")
...
let posicion=-1;
    ...
    if (posicion!==-1){
        console.log(`La marca ${modelo} se encuentra en la posición ${posicion} del array.`)
    }
