...
Creá la función backEnd() que recibirá 2 números como parámetros. La función deberá imprimir por pantalla los números del 1 al 100, pero
...
let num1=parseFloat(prompt("Ingrese el primer párametro: "))
let num2=parseFloat(prompt("Ingrese el segundo parametro: "))
